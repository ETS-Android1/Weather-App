...
public class DailyWeatherAdapter extends ArrayAdapter<ForecastWeather> {
    ...
    private ArrayList<ForecastWeather> weathers;

    private DailyWeatherAdapter() {
        super(MainActivity.getAppContext(), 0, new ArrayList<ForecastWeather>());
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.temperatureBoxDailyForecast)).setText(presenter.convertToCelcium(forecast.getData().getTemp()) + "°");
        ((TextView) convertView.findViewById(R.id.weatherNameBoxDailyForecast)).setText(forecast.getWeathers().get(0).getMain());
        return convertView;
    }

    public void setData(ArrayList<ForecastWeather> weathers) {
